...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_tablero_t, stringdata) + ofs \
...
const QMetaObject tablero::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_tablero.data,
      qt_meta_data_tablero,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_tablero.stringdata))
